                ...
                <Table className="table-hover table-striped">
                  <thead>
                    <tr>
                      ...
                      <th className="border-0">Tipo de Sangre</th>
                      <th className="border-0">Rango</th>
                      <th className="border-0">Fecha de Reclutamiento</th>
                  ...
                  <tbody>
                    {data?.volunteers.map((volunteer) => (
                      <tr key={volunteer.id}>
                        ...
                        <td>{get_formatted_date(volunteer.incorporation_date)}</td>
                        <td>
                          <Button
                          ...
                          <Button className="btn-sm ml-2" variant="danger" onClick={() => handleDelete(volunteer.id)}>
                            {" "}
                            Eliminar{" "}
                          </Button>
                        </td>
