    ...
    <Navbar bg="light" expand="lg">
      <Container fluid>
        <div className="d-flex justify-content-center align-items-center ml-2 ml-lg-0">
          <Navbar.Brand href="/" className="mr-2" > {getBrandText()} </Navbar.Brand>
        </div>
          ...
          <Nav className="ml-auto" navbar>
            ...
            <Dropdown as={Nav.Item}>
              ...
              <Dropdown.Menu aria-labelledby="navbarDropdownMenuLink">
                ...
                <Dropdown.Item href="#url" onClick={(e) => e.preventDefault()}>Something else here</Dropdown.Item>
                <div className="divider"></div>
                <Dropdown.Item href="#url" onClick={(e) => e.preventDefault()} > Separated link </Dropdown.Item>
              </Dropdown.Menu>
            </Dropdown>
            <Nav.Item>
              <Nav.Link
